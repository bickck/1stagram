...
public class MemberController {
	...
	@PostMapping("/modify")
	public void modify(MultipartHttpServletRequest mul, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
	...
	@PostMapping("/profileImageChange")
	public void proFileImageChange(@RequestParam(value = "file") MultipartFile multipartFile,
			HttpServletRequest request, HttpServletResponse response) throws Exception {

	}

	@GetMapping("/delete")
	public void delete(@RequestParam String email, @RequestParam String imgName, HttpServletRequest request,
